...
while True:
    ...
    for (x,y,w,h) in faces:
        ...
        exist=os.path.isfile("C://Users/shali/Downloads/face_recognition_project-main/attendance" + date + ".csv")
    ...
    if k==ord('o'):
        ...
        if os.path.exists("C://Users/shali/Downloads/face_recognition_project-main/attendance.csv"):
            with open("C://Users/shali/Downloads/face_recognition_project-main/attendance" + date + ".csv", "+a",newline='') as csvfile:
